...
class TelrViewController: UIViewController {
...
//
    ...
    let KEY:String = "ttcbT^Zkp3-DG82p" //"????????"  // TODO fill key
    let STOREID:String = "23258" //"?????????"         // TODO fill store id
    let EMAIL:String = "utkarsh3441@gmail.com"

...
class MockData {
    static func createMockAppointment(appointmentArray:[[String:Any]]) -> [DotAppointmentModel] {
        ...
        for appointment in appointmentArray{
            mockAppointments.append(DotAppointmentModel(appointment_id: appointment["appointment_id"] as? Int ?? 0, patient_id: appointment["patient_id"] as? Int ?? 0, doctor_slot_id: appointment["doctor_slot_id"] as? Int ?? 0, facility_slot_id: appointment["facility_slot_id"] as? Int ?? 0, payment_id: appointment["payment_id"] as? Int ?? 0, purpose: appointment["purpose"] as? String ?? "Not Available", remarks: "Remarks Given", status: appointment["status"] as? String ?? "Not Available", payment_amount: 1000, provider_id: appointment["provider_id"] as? Int ?? 0, provider_name: appointment["provider_name"] as? String ?? "Not Available", provider_type: appointment["provider_type"] as? String ?? "Not Available", slot_date: appointment["slot_date"] as? String ?? "18-Aug-2020", start_time: appointment["start_time"] as? String ?? "Not Available", end_time: appointment["start_time"] as? String ?? "Not Available"))
        }
    ...
    static func createMockMedicne()->[MyMedicineModel]{
        ...
        mockMedicineModel.append(MyMedicineModel(appointment_id: 1, days: 4, dosage_instructions: "2 times a day", drug_name: "Paracetamol", medication_id: 1, patient_id: 1))
